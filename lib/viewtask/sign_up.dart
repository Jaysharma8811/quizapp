...
import 'package:quizappp/widets/custom_text_field.dart';
import 'package:quizappp/widets/snackbar.dart';

import '../Data/Network/Firebase/firebase_services.dart';
import '../controller/get_sign_up_controller.dart';
import 'login.dart';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image.asset("images/quiz_logo.png",height: MediaQuery.sizeOf(context).height/2.8,),
                  Row(
